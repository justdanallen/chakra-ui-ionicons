...
export const PlaySkipForwardOutline = (props: IconProps) => (
  <Icon viewBox='0 0 512 512' {...props}>
    ...
    <path  fill='none' stroke='currentColor' stroke-linecap='round' stroke-miterlimit='10' stroke-width='32' d='M400 80v352'/>
  </Icon>
);