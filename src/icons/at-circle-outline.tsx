...
export const AtCircleOutlineIcon = (props: IconProps) => (
<Icon viewBox='0 0 512 512' fill="currentcolor" stroke="currentcolor" {...props}>
  <path  d='M448.08 256.08c0-106-86-192-192-192s-192 86-192 192 86 192 192 192 192-85.97 192-192z' fill='none' stroke='currentColor' strokeMiterlimit='10' strokeWidth='32'/>
