...
export const IdCardOutline = (props: IconProps) => (
  <Icon viewBox='0 0 512 512' {...props}>
    <rect  x='96' y='32' width='320' height='448' rx='48' fill='none' stroke='currentColor' stroke-linejoin='round' stroke-width='32'/>
