...
export const BatteryFullOutline = (props: IconProps) => (
  <Icon viewBox='0 0 512 512' {...props}>
    ...
    <rect  x='85.69' y='198.93' width='292.63' height='114.14' rx='4' ry='4' stroke='currentColor' stroke-linecap='square' stroke-miterlimit='10' stroke-width='32'/>
