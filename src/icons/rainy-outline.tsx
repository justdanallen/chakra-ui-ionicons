...
export const RainyOutline = (props: IconProps) => (
  <Icon viewBox='0 0 512 512' {...props}>
    ...
    <path  fill='none' stroke='currentColor' stroke-linecap='round' stroke-linejoin='round' stroke-width='32' d='M144 384l-32 48M224 384l-64 96M304 384l-32 48M384 384l-64 96'/>
  </Icon>
);